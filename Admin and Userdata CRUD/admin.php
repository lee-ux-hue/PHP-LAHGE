...
<body>
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li><a href="user.php">Enter User Data </a></li>
      <li><a href="admin.php">Enter Admin Data </a></li>
...
<form method ="post"   action="">
	<h1>ID Number (Use to Search Admin data)</h1>
  <input type="number" name="id"  class="form-control" placeholder="ID No. /Automatic Number Genrates" value="<?php echo($id);?>" disabled>
		<h1>Admin Name</h1>
	<input type="text" name="name" class="form-control" placeholder="Enter Admin Name" value="<?php echo($name);?>"required>
<h1>Email</h1>
...
<div class="col-xs-6">
 ...
 <select name="branch" class="form-control" value="<?php echo($branch);?>">
  ...
  <select name="gender" class="form-control" value="<?php echo($gender);?>">
    ...
    <a href="updateadmindata.php"<button class="btn btn-info btn-block btn-lg">Update | Delete | Find</button></a>
