...
<body>
  ...
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="Home.php">USER & ADMIN System</a>
    </div>
...
<form method ="post"   action="">
  ...
  <input type="number" name="id"  class="form-control" placeholder="ID No. /Automatic Number Genrates" value="<?php echo($id);?>">
		<h1>Admin Name</h1>
	<input type="text" name="name" class="form-control" placeholder="Enter Admin Name" value="<?php echo($name);?>" >
<h1>Email</h1>
...
<input type="text" name="gender" class="form-control" placeholder="gender" value="<?php echo($gender);?>" >
    ...
    <div class="col-lg-8">
			<h2>ADMIN Data Update | Delete</h2>
<?php
$servername = "localhost: 3307";
$username = "root";
$password = "";
